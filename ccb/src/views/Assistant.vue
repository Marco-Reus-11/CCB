        ...
        <div class="middle" ref="messageList">
            <ul>
                <li class="message" v-for="(message, index) in messages" :key="index">
                    <div class="avatar" v-if="message.from === 'AI'"><img src="https://reus.oss-cn-shenzhen.aliyuncs.com/images/ds.jpg" alt="AI头像"></div>
                ...
                <li class="message" v-if="isLoading">
                    <div class="avatar"><img src="https://reus.oss-cn-shenzhen.aliyuncs.com/images/ds.jpg" alt="AI头像"></div>
                    <div class="text">
...
// const aiAvatar = "https://reus.oss-cn-shenzhen.aliyuncs.com/images/ds.jpg";
